...
function GroupProducts({productos, categoria, id_categoria, mostrarFiltro, setProductos}) {
    ...
    const manejarFiltroPrecio = (evento, precio) => {
        // despues de cambiar el estado de filtroPrecio a un array, el parametro precio es otro array
    ...
    return (
        <div className="container">
            ...
            {mostrarFiltro ? (
            <div>
            <button className="btn btn-outline-dark btn-sm" onClick={()=>{setToggleFiltro(!toggleFiltro)}}>
                <i className="fas fa-funnel-dollar me-1"></i>Filtros</button>
            {toggleFiltro ? (
